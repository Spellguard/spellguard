...
description: Disconnect this machine from Spellguard. Use when the user runs the spellguard-reset wrapper, wants a from-scratch setup test, or needs to cleanly tear down the agent on this machine (deregister server-side, stop the daemon, delete the local credential).
---
