...
/**
 * Back-compat shim for the published `@spellguard/claude-code-plugin/agent-control`
 * subpath export.
 *
 ...
 * external consumer still importing `@spellguard/claude-code-plugin/agent-control`
